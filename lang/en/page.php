...
$string['conceptshelp'] = 'In this field you can write the concepts related to the content of the page.';
...
$string['dropdownform'] = 'Display the form';
$string['teacheremail'] = 'Add here the teacher mail ';
$string['availableteachers'] = 'Course teachers';
